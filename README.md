...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/gBDzXEZzdT)
...
```sh
npx nx serve shop-cars
```

To create a production bundle:

```sh
npx nx build shop-cars
```

To see all available targets to run for a project, run:

```sh
npx nx show project shop-cars
```
